    ...
    <header className="sticky top-0 z-50 w-full border-b border-[#D4AF37]/20 bg-white/90 dark:bg-[#0A0A0A]/90 backdrop-blur">
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden md:flex space-x-8 items-center">
          ...
          <Link href="/posiciones" className="text-sm font-bold uppercase tracking-widest text-black dark:text-white hover:text-[#D4AF37] transition-colors">Posiciones</Link>
      ...
      >
        <nav className="flex flex-col pt-20 px-6 space-y-6">
          ...
          <Link href="/posiciones" onClick={toggleMenu} className="text-lg font-bold uppercase tracking-widest text-black dark:text-white hover:text-[#D4AF37] transition-colors">Posiciones</Link>
