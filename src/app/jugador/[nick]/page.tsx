...
export default async function JugadorPage({ params }: { params: Promise<{ nick: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      <Link href="/equipos" className="text-[#B8860B] dark:text-[#D4AF37] hover:underline mb-8 inline-block font-bold uppercase tracking-widest text-sm">
        &larr; Volver a Equipos
      </Link>
      
      <div className="border border-[#B8860B] dark:border-[#D4AF37]/50 bg-white dark:bg-[#191B1F] shadow-[0_0_30px_rgba(212,175,55,0.15)] rounded-xl overflow-hidden">
        {/* Banner superior */}
        <div className="h-32 bg-gradient-to-r from-[#0A0A0A] via-[#D4AF37]/20 to-[#0A0A0A] relative border-b border-[#B8860B] dark:border-[#D4AF37]/30">
          <div className="absolute -bottom-16 left-8">
            <div className="h-32 w-32 rounded-full border-4 border-[#191B1F] bg-white dark:bg-[#0A0A0A] overflow-hidden flex items-center justify-center">
              {/* Placeholder foto */}
        ...
        <div className="pt-20 px-8 pb-8">
          <div className="flex justify-between items-start mb-8">
            <div>
              <h1 className="text-4xl font-black text-gray-900 dark:text-white uppercase tracking-wider">{decodedNick}</h1>
              <p className="text-[#B8860B] dark:text-[#D4AF37] font-bold text-lg mt-1 tracking-widest">{playerTeam.team}</p>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            <div className="bg-white dark:bg-[#0A0A0A] p-4 border border-gray-300 dark:border-gray-800 rounded">
              <div className="text-gray-500 text-xs uppercase tracking-widest mb-1">KDA</div>
              <div className="text-2xl font-bold text-gray-900 dark:text-white">4.2<span className="text-sm text-gray-600">/1</span></div>
            </div>
            <div className="bg-white dark:bg-[#0A0A0A] p-4 border border-gray-300 dark:border-gray-800 rounded">
            ...
            <div className="bg-white dark:bg-[#0A0A0A] p-4 border border-gray-300 dark:border-gray-800 rounded">
              ...
              <div className="text-2xl font-bold text-gray-900 dark:text-white">720</div>
            </div>
            <div className="bg-white dark:bg-[#0A0A0A] p-4 border border-gray-300 dark:border-gray-800 rounded">
