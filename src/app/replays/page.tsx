  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mb-12 text-center">
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-400 text-lg">Revive los mejores momentos del Coliseo.</p>
      </div>
        ...
        {replays.map((replay) => (
          ...
          >
            <div className="mb-4 flex items-start justify-between">
              <div>
                <h2 className="mb-1 font-serif text-2xl font-bold text-gray-900 dark:text-white uppercase">{replay.title}</h2>
                <span className="text-sm tracking-widest text-[#0066FF] dark:text-[#53FC18] font-bold">{replay.date}</span>
              </div>
              <div className="rounded bg-white dark:bg-[#0A0A0A] border border-[#B8860B] dark:border-[#D4AF37] px-2 py-1 text-xs font-bold text-[#B8860B] dark:text-[#D4AF37]">
                KICK
              </div>
            </div>
